 ...
 */
extern "C" int robinson_fould(string& tree1, string& tree2);
...
//  * (n * i + j)-th element of the list represents the distance between i-th
//  and
...
PYBIND11_MODULE(_piqtree, m) {
  ...
  //         "allows:\"YULE_HARDING\", \"UNIFORM\", \"CATERPILLAR\",
  //         \"BALANCED\", "
  ...
  //   m.def("mine", &mine, "The meaning of life, the universe (and
  //   everything)!");
}
